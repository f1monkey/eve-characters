<?php  //[STAMP] 1ea74093c1c8f03d6aa448678e98085a
...
trait IntegrationTesterActions
{
     ...
     */
    public function runSymfonyConsoleCommand($command, $parameters = null, $consoleInputs = null, $expectedExitCode = null) {
     ...
     *
     * @param object $entity
     * @see \Helper\Integration::haveInRepository()
     */
    public function haveInRepository($entity): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveInRepository', func_get_args()));
    }
     ...
     *
     * @return object
     * @see \Helper\Integration::grabEntityFromRepository()
     */
    public function grabEntityFromRepository($class, $id): object {
     ...
     *
     * @return User
     * @see \Helper\Integration::createUser()
     */
    public function createUser($username = null, $email = null): \App\Entity\User {
     ...
     * @see \Helper\Integration::loadFixtures()
     */
     ...
     *
     * @return RefreshToken
     * @see \Helper\Integration::createRefreshToken()
     */
    public function createRefreshToken($username, $value = null): \App\Entity\RefreshToken {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createRefreshToken', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Integration::grabParameter()
     */
     ...
     *
     * @return AuthCode
     * @see \Helper\Integration::createAuthCode()
     */
    public function createAuthCode($user, $authCode = null): \App\Entity\AuthCode {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createAuthCode', func_get_args()));
    }
}
